...
export const defaultState={version:1,weekOffset:0,days:['Lunes','Martes','Miércoles','Jueves','Viernes','Sábado','Domingo'].map((name,i)=>({name,breakfast:{text:['Café, fruta y tostadas','Yogur con fruta','Tostadas y café','Avena con fruta','Café y tostadas','Desayuno libre','Desayuno tranquilo'][i],done:false},lunch:{text:['Pollo con arroz y verduras','Pasta con tomate y atún','Lentejas','Ensalada completa','Arroz con verduras','Comida familiar','Asado / comida familiar'][i],done:false},dinner:{text:['Tortilla y ensalada','Crema de verduras','Pescado con verduras','Wraps de pollo','Pizza casera','Cena libre','Cena ligera'][i],done:false},note:''})),shopping:[{id:'1',text:'Leche',done:false},{id:'2',text:'Huevos',done:false},{id:'3',text:'Fruta',done:false},{id:'4',text:'Verduras',done:false}],pantry:[{id:'p1',text:'Leche',category:'Nevera',quantity:'2 bricks',level:'ok'},{id:'p2',text:'Huevos',category:'Nevera',quantity:'6',level:'low'},{id:'p3',text:'Arroz',category:'Despensa',quantity:'1 paquete',level:'ok'},{id:'p4',text:'Café',category:'Despensa',quantity:'',level:'out'},{id:'p5',text:'Pollo',category:'Congelador',quantity:'2 raciones',level:'ok'}],updatedAt:null,updatedBy:'Familia Laviña Pérez'};
